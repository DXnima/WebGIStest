...
public class SpatialRelation {
    ...
    private static GeometryFactory geometryFactory = new GeometryFactory(new PrecisionModel(PrecisionModel.FLOATING), 4326);
    ...
    public static void main(String[] args){
        ...
        try {
            ...
            System.out.println(polygon.contains(line));
            System.out.println(polygon.overlaps(polygon1));

            System.out.println("--------空间计算--------");
            Geometry intersec=polygon.union(polygon1);
